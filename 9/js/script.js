...
/* harmony import */ var _theme_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./theme-controller */ "./source/js/modules/theme-controller.js");
...
class FullPageScroll {
  ...
  changePageDisplayHandler() {
    ...
    if (isNeedSetDefaultTheme) {
      _theme_controller__WEBPACK_IMPORTED_MODULE_1__["default"].setDefaultTheme();
    } else if (isNeedSetActiveTheme) {
      _theme_controller__WEBPACK_IMPORTED_MODULE_1__["default"].setActiveTheme();
    }
  }
        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              sliderContainer.style.backgroundImage = `url("img/slide1.jpg"), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
              _theme_controller__WEBPACK_IMPORTED_MODULE_1__["default"].setTheme(`purple`);
              ...
              _theme_controller__WEBPACK_IMPORTED_MODULE_1__["default"].setTheme(`blue-light`);
              ...
              _theme_controller__WEBPACK_IMPORTED_MODULE_1__["default"].setTheme(`blue`);
...
/***/ "./source/js/modules/theme-controller.js":
/*!***********************************************!*\
  !*** ./source/js/modules/theme-controller.js ***!
  \***********************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/words-animations.js":
/*!***********************************************!*\
  !*** ./source/js/modules/words-animations.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ((screenClass, elementClass, animationSettings) => {
...
/* harmony import */ var _modules_words_animations__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/words-animations */ "./source/js/modules/words-animations.js");
// modules
...
wordsElements.forEach((item) => {
  Object(_modules_words_animations__WEBPACK_IMPORTED_MODULE_9__["default"])(item.screenId, item.elementClass, item.settings);
});
